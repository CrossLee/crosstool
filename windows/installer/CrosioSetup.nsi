...
VIAddVersionKey /LANG=2052 "ProductName" "一爪"
VIAddVersionKey /LANG=2052 "FileDescription" "一爪 图形化安装器"
VIAddVersionKey /LANG=2052 "FileVersion" "${CROSIO_VERSION}"
VIAddVersionKey /LANG=2052 "ProductVersion" "${CROSIO_VERSION}"
VIAddVersionKey /LANG=2052 "LegalCopyright" "一爪 contributors"
...
!define MUI_WELCOMEPAGE_TITLE "欢迎安装 一爪"
!define MUI_WELCOMEPAGE_TEXT "即将安装 一爪 ${CROSIO_VERSION}${CROSIO_FLAVOR_TEXT}。$\r$\n$\r$\n安装器会自动选择 x64 或 ARM64 版本，无需输入命令。更新会保留已有设置。$\r$\n$\r$\n安装前请退出正在运行的 一爪，然后点击“安装”。"
!define MUI_PAGE_CUSTOMFUNCTION_SHOW WelcomeShown
!insertmacro MUI_PAGE_WELCOME
!define MUI_INSTFILESPAGE_ABORTHEADER_TEXT "安装失败"
!define MUI_INSTFILESPAGE_ABORTHEADER_SUBTEXT "一爪 未完成安装。请查看提示后重试。"
!insertmacro MUI_PAGE_INSTFILES
!define MUI_FINISHPAGE_TITLE "一爪 安装完成"
!define MUI_FINISHPAGE_TEXT "一爪 已安装成功。$\r$\n$\r$\n请在开始菜单中搜索 一爪。卸载时请使用 Windows 设置中的“已安装的应用”。"
!define MUI_FINISHPAGE_RUN
!define MUI_FINISHPAGE_RUN_TEXT "立即打开 一爪"
...
Function .onInit
  SetErrorLevel 2
  ${IfNot} ${RunningX64}
    MessageBox MB_OK|MB_ICONSTOP "一爪 需要 Windows 11 的 x64 或 ARM64 版本。"
    Quit
  ${EndIf}
  ReadRegStr $0 HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion" "CurrentBuildNumber"
  ${If} $0 < 22000
    MessageBox MB_OK|MB_ICONSTOP "一爪 需要 Windows 11 或更新的桌面版系统。"
    Quit
  ${EndIf}
...
Function OpenCrosio
  ...
  Pop $EngineOutput
  ${If} $EngineExitCode != "0"
    MessageBox MB_OK|MB_ICONINFORMATION "一爪 已安装。自动打开未完成，请在开始菜单中搜索 一爪。"
  ${EndIf}
  SetErrorLevel 0
FunctionEnd
