...
核验日期：2026-09-09。本文是签名前置审计和实施清单，**不表示已取得 Windows 可信证书或已发布签名版**。产品品牌为一爪 OnePaw；0.1.21.0 开发版已统一显示名和新安装包文件名，内部 Windows 应用身份保持兼容。下文的旧文件名、哈希和提交链接是 0.1.20.0 的原始审计记录，不应改写成新版本证据。
